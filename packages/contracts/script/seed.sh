#!/bin/bash
# Seed the local Anvil instance with test data
set -e
...
echo "Anvil is running. Deploying contracts and seeding data..."
...
echo ""
echo "Seeding complete! Check seed-output/ for JSON data."
